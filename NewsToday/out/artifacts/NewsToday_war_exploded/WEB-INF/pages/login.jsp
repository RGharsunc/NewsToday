    ...
    <section id="contentSection" style="margin-top: 50px; margin-bottom: 50px">
        <div class="row ">
            <div class="col-lg-8 col-md-8 col-sm-8 well"
                 style="margin-left: 430px;margin-top: 30px; width: 240px; height: auto; background-color: black" >
                <form action="/login" class="contact_form"  name="loginForm" method="post"  style="width: 200px">

                    <input class="form-control" type="email" placeholder="Username*" name="j_username" style="background-color: #ed6a12;">
                    <input class="form-control" type="password" placeholder="Password*" name="j_password" style="background-color: #ed6a12"><br>
